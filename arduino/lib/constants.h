/* THIS FILE WAS AUTOGENERATED ON 2023-07-24T09:43:49.701Z */
...
int16_t parseIntFromChar(uint8_t value){
  if((int16_t) value < (int16_t) 0) { return (int16_t) 0; }
  if((int16_t) value > (int16_t) 255) { return (int16_t) 255; }
...
void controllerInputFromBuffer(uint8_t buffer[SERIAL_BUFFER_LENGTH], ControllerInput *cinput){
  ...
  cinput->AXIS_LSX = parseIntFromChar(buffer[19]) - parseFloatFromChar(buffer[20]);
  cinput->AXIS_LSY = parseIntFromChar(buffer[21]) - parseFloatFromChar(buffer[22]);
  cinput->AXIS_RSX = parseIntFromChar(buffer[23]) - parseFloatFromChar(buffer[24]);
  cinput->AXIS_RSY = parseIntFromChar(buffer[25]) - parseFloatFromChar(buffer[26]);
}
