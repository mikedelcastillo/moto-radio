...
#define BUTTON_LT_BYTE 6
#define BUTTON_LB_BYTE 7
#define BUTTON_RT_BYTE 8
...
ControllerInputType getControllerInputType(uint8_t value){
  ...
  if(value == 6) { return CI_BUTTON_LT; }
  if(value == 7) { return CI_BUTTON_LB; }
  if(value == 8) { return CI_BUTTON_RT; }
...
void setControllerInputValue(ControllerInput *cinput, uint8_t input, uint8_t value){
  ...
  if(input == 6) { cinput->BUTTON_LT = intValue; }
  if(input == 7) { cinput->BUTTON_LB = intValue; }
  if(input == 8) { cinput->BUTTON_RT = intValue; }
